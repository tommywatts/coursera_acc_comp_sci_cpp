...
int GridGraph::countEdges() const {
  ...
  for ( auto mapIter = adjacencyMap.begin() ; mapIter != adjacencyMap.end() ; mapIter++ ) {

    auto edges = mapIter->second;
...
void GridGraph::removePoint(const IntPair& p1) {
  ...
  // TODO: Your code here!
  // =======================================================================
  for (auto idx = originalNeighbors.begin(); idx != originalNeighbors.end(); idx++) {
    removeEdge(*idx, p1);
  }
